...
object ClustererProtocol {
  ...
  private final class DistanceResult1(t1: Int, t2: Int, dist: Double,
                                      override val isApproximate: Boolean,
                                      override val isEstimated: Boolean = false) extends DistanceResult {
  ...
  object EstimatedDistance {
    def apply(t1: Int, t2: Int, dist: Double): DistanceResult =
      new DistanceResult1(t1, t2, dist, isApproximate = false, isEstimated = true)

    def apply(t1a: Int, t1b: Int, dist1: Double,
              t2a: Int, t2b: Int, dist2: Double): DistanceResult =
      new DistanceResult2(t1a, t1b, dist1, t2a, t2b, dist2, isApproximate = false, isEstimated = true)
