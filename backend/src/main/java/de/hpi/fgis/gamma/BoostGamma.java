// Adapted from the apache commons library:
// https://github.com/apache/commons-numbers/blob/c0d62e5f678bc0b76f09b3724ab451e553af3a21/commons-numbers-gamma/src/main/java/org/apache/commons/numbers/gamma/BoostGamma.java
// Original comments have been preserved. Unused code has been removed. Precision has been reduced to double.
package de.hpi.fgis.gamma;
...
//  Copyright Sebastian Schmidl 2025.
 ...
 *
 * @see <a href="https://www.boost.org/doc/libs/1_77_0/libs/math/doc/html/math_toolkit/sf_gamma.html">
...
public final class BoostGamma {
    ...
    // - Removed extended precision code again.
    //
    // Note:
     ...
     * <h2>Warning</h2>
     *
     * <p>This is not a substitute for LanczosApproximation. The approximation is
    ...
    public static final class Lanczos {
         ...
         * Lanczos constant G.
         */
        public static final double G = 6.024680040776729583740234375;
         ...
         */
        public static final double GMH = 5.524680040776729583740234375;
         ...
         */
        public static double lanczosSum(double z) {
            final double[] num = {
         ...
         */
        public static double lanczosSumExpGScaled(double z) {
     ...
     * LanczosApproximation class.
     *
     * @param z Argument z
     * @return gamma value
     */
    public static double tgamma(double z) {
        // Handle integers
        if (Math.rint(z) == z) {
            if (z <= 0) {
                // Pole error
     ...
     * @return log gamma value
     */
    public static double lgamma(double z, int[] sign) {
        double result;
        int sresult = 1;
        if (z <= -ROOT_EPSILON) {
            // reflection formula:
            ...
            // TODO: Use an extended precision sum to reduce cancellation.
            result = BigDecimal.valueOf(-lgamma(z))
                    .add(BigDecimal.valueOf(-Math.log(t)))
                    .add(BigDecimal.valueOf(LOG_PI))
                    .doubleValue();
    ...
    private static double lgammaSmall(double z, double zm1, double zm2) {
        ...
        // TODO: Update to use an extended precision sum
        ...
        if ((zm1 == 0) || (zm2 == 0)) {
            ...
            if (z >= 3) {
                do {
                    z -= 1;
                    result = result.add(BigDecimal.valueOf(Math.log(z)));
                } while (z >= 3);
            ...
            result = result.add(BigDecimal.valueOf(r * Y)).add(BigDecimal.valueOf(r * R));
        } else {
            //
            ...
            if (z <= 1.5) {
                ...
                result = result.add(BigDecimal.valueOf(prefix * Y)).add(BigDecimal.valueOf(prefix * r));
            } else {
                //
                // Use the following form:
                //
