...
// https://github.com/apache/commons-numbers/blob/c0d62e5f678bc0b76f09b3724ab451e553af3a21/commons-numbers-gamma/src/main/java/org/apache/commons/numbers/gamma/InvGamma1pm1.java
...
final class InvGamma1pm1 {
    ...
    public static double value(final double x) {
        if (x < -0.5 || x > 1.5) {
            throw new RuntimeException("%f OUT_OF_RANGE [%f, %f]".formatted(x, -0.5, 1.5));
        }
