...
import de.hpi.fgis.bloomfilter.CanGetDataFrom
...
object MurmurHash3Generic {
  ...
  def murmurhash3_x64_128[From](key: From, offset: Int, len: Int, seed: Int)(using cgdf: CanGetDataFrom[From]): (Long, Long) =
  ...
  def murmurhash3_x64_64[From](key: From, offset: Int, len: Int, seed: Int)(using cgdf: CanGetDataFrom[From]): Long =
    var h1: Long = seed & 0x00000000FFFFFFFFL
    var h2: Long = seed & 0x00000000FFFFFFFFL
