  ...
  "The Lorentzian distance" when {
    ...
    "given two equal-length arrays" should {
      ...
      "compute correctly" in {
        ...
        lorentzian(x, y) shouldEqual 0.3309357670 +- 1e-9
      }
    }
    "given two unequal-length arrays" should {
      ...
      "compute correctly" in {
        ...
        lorentzian(x, y) shouldEqual 0.3069041170 +- 1e-9
      }
    }
  }
  ...
  "The Lorentzian pairwise distance" when {
    ...
    "given two equal-length arrays" should {
      ...
      "compute correctly" in {
        ...
        val expected = Array(Array(0.0, 0.3309357670), Array(0.3309357670, 0.0))
    ...
    "given two unequal-length arrays" should {
      ...
      "compute correctly" in {
        ...
        val expected = Array(Array(0.0, 0.3069041170), Array(0.3069041170, 0.0))
        lorentzian.pairwise(x) shouldEqual expected
      }
    }
